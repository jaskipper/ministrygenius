<?php
	...
	define('ECKO_THEME_VERSION', '2.3.0');
	...
	if(!function_exists('koala_widgets_init')){
		function koala_widgets_init(){
			register_sidebar(array(
				'name' => esc_html('Footer (Max 3. Widgets)', 'koala'),
				'id' => 'footer',
				'description' => esc_html('Appears in footer on all pages. Maximum of 3 widgets supported.', 'koala'),
	...
	if(!function_exists('koala_options_meta_box')){
		...
		?>
			...
			<p>
				<strong><?php esc_html_e('Post Feature', 'koala'); ?></strong><br>
				<p class="howto"><?php esc_html_e('Configure where the post is displayed within the front-page header and post-list sections.', 'koala'); ?></p>
				...
				<label for="postfeature-postlistonly"><?php esc_html_e('Post List Only', 'koala'); ?></label><br>
				...
				<label for="postfeature-postslider"><?php esc_html_e('Slide and Post List', 'koala'); ?></label><br>
				...
				<label for="postfeature-postgrid"><?php esc_html_e('Grid and Post List', 'koala'); ?></label><br>
				...
				<label for="postfeature-postgridfeatured"><?php esc_html_e('Grid (Featured) and Post List', 'koala'); ?></label><br>
			</p>
			<hr>
			<p>
				<strong><?php esc_html_e('Post Header', 'koala'); ?></strong><br>
				<p class="howto"><?php esc_html_e('Configure the header style within the post/custom page.', 'koala'); ?></p>
				...
				<label for="postheader-standard"><?php esc_html_e('Standard (Minimal)', 'koala'); ?></label><br>
				...
				<label for="postheader-banner"><?php esc_html_e('Banner (Half Page)', 'koala'); ?></label><br>
				...
				<label for="postheader-cover"><?php esc_html_e('Cover (Full Page)', 'koala'); ?></label><br>
			</p>
			<hr>
			<p>
				<strong><?php esc_html_e('Post-List Style', 'koala'); ?></strong><br>
				<p class="howto"><?php esc_html_e('Configure the post appearance within the post-list. Standard and Link formats only.', 'koala'); ?></p>
				...
				<label for="postlist-standard"><?php esc_html_e('Standard (Left Thumbnail)', 'koala'); ?></label><br>
				...
				<label for="postlist-banner"><?php esc_html_e('Banner (Large)', 'koala'); ?></label><br>
			</p>
			<hr>
			<p>
				<strong><?php esc_html_e('Page Layout', 'koala'); ?></strong><br>
				<p class="howto"><?php esc_html_e('Configure the page layout of the individual post/custom page.', 'koala'); ?></p>
				...
				<label for="pagelayout-rightsidebar"><?php esc_html_e('Right Sidebar (Default)', 'koala'); ?></label><br>
				...
				<label for="pagelayout-leftsidebar"><?php esc_html_e('Left Sidebar', 'koala'); ?></label><br>
				...
				<label for="pagelayout-fullwidth"><?php esc_html_e('Full Width', 'koala'); ?></label><br>
			</p>
			<hr>
			<p class="howto"><?php esc_html_e('More information on these post/page options can be found within the theme documentation under Post Formatting.', 'koala'); ?></p>
	...
	if(!function_exists('koala_get_default_widgets')){
		function koala_get_default_widgets(){
			if(class_exists('ecko_widget_latest_posts')){ the_widget('ecko_widget_latest_posts', array('title' => esc_html__('Latest Posts', 'koala'), 'postcount' => 7)); }
	...
	if(!function_exists('koala_category_options')){
		function koala_category_options($tag){
			...
			?>
			<tr class="form-field">
				<th scope="row" valign="top"><label for="category-color"><?php esc_html_e('Category HEX Color Value', 'koala'); ?></label></th>
				<td>
					...
					<p class="description"><?php esc_html_e('Enter a color to associate with this category. The color must be in HEX format (E.g. 009bbb )', 'koala'); ?></p>
				</td>
			</tr>
			<?php
		}
		...
		function koala_get_slider_background(){
			...
			if(count($slider_post)){
				...
				if(has_post_thumbnail($slider_post[0]->ID)){
					$post_image = wp_get_attachment_image_src(get_post_thumbnail_id($slider_post[0]->ID), 'ecko_background');
	...
	function koala_customize_register($wp_customize){
		...
		$wp_customize->add_section('layout_section',
			array(
				'title' => esc_html('Layout', 'koala'),
				'description' => esc_html('This section contains theme layout options.', 'koala'),
				'priority' => 23,
			)
		);
		...
		$wp_customize->add_control(
			new WP_Customize_Image_Control($wp_customize, 'layout_header_background',
				array(
					'label' => esc_html('Default Header Background Image', 'koala'),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'radio',
				'label' => esc_html('Sidebar Position', 'koala'),
				'section' => 'layout_section',
				'choices' => array(
					"sidebar-right" => esc_html('Right Sidebar', 'koala'),
					"sidebar-left" => esc_html('Left Sidebar', 'koala'),
				),
			)
		);
		...
		$wp_customize->add_section('topbar_section',
			array(
				'title' => esc_html('Top Bar', 'koala'),
				'description' => esc_html('This section contains Top bar options.', 'koala'),
				'priority' => 23,
			)
		);
		...
		$wp_customize->add_control('topbar_disable_sticky',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Disable Sticky Behaviour', 'koala'),
		...
		$wp_customize->add_control('topbar_hide_navigation',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Navigation', 'koala'),
				'section' => 'topbar_section',
			)
		);
		...
		$wp_customize->add_control('topbar_hide_search',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Search Option', 'koala'),
				'section' => 'topbar_section',
			)
		);
		...
		$wp_customize->add_control('topbar_show_search_mobile',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Show Search (Mobile)', 'koala'),
				'section' => 'topbar_section',
			)
		);
		...
		$wp_customize->add_section('postslider_section',
			array(
				'title' => esc_html('Header - Post Slider', 'koala'),
				'description' => esc_html('This section contains Post Slider options.', 'koala'),
				'priority' => 23,
			)
		);
		...
		$wp_customize->add_control('postslider_hide',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Post Slider', 'koala'),
		...
		$wp_customize->add_control('postslider_all_formats',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Show All Post Format Types', 'koala'),
				'section' => 'postslider_section',
			)
		);
		...
		$wp_customize->add_control('postslider_hide_category',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Post Category', 'koala'),
				'section' => 'postslider_section',
			)
		);
		...
		$wp_customize->add_control('postslider_hide_excerpt',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Excerpt', 'koala'),
				'section' => 'postslider_section',
			)
		);
		...
		$wp_customize->add_control('postslider_hide_meta',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Meta', 'koala'),
				'section' => 'postslider_section',
			)
		);
		...
		$wp_customize->add_section('postgrid_section',
			array(
				'title' => esc_html('Header - Post Grid', 'koala'),
				'description' => esc_html('This section contains Post Grid options.', 'koala'),
				'priority' => 23,
			)
		);
		...
		$wp_customize->add_control('postgrid_hide',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Post Grid', 'koala'),
		...
		$wp_customize->add_control('postgrid_hide_category',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Category', 'koala'),
				'section' => 'postgrid_section',
			)
		);
		...
		$wp_customize->add_control('postgrid_hide_author',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Author', 'koala'),
				'section' => 'postgrid_section',
			)
		);
		...
		$wp_customize->add_control('postgrid_hide_date',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Date', 'koala'),
				'section' => 'postgrid_section',
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'radio',
				'label' => esc_html('Post to Show:', 'koala'),
				'section' => 'postgrid_section',
				'choices' => array(
					"2" => esc_html('2 Posts (1 Row)', 'koala'),
					"5" => esc_html('5 Posts (2 Rows)', 'koala'),
					"8" => esc_html('8 Posts (3 Rows)', 'koala'),
				),
			)
		);
		...
		$wp_customize->add_section('postlist_section',
			array(
				'title' => 'Post List',
				'description' => esc_html('This section contains Post List options.', 'koala'),
				'priority' => 27,
			)
		);
		...
		$wp_customize->add_control('postlist_hide_readmore',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Read More', 'koala'),
				'section' => 'postlist_section',
			)
		);
		...
		$wp_customize->add_control('postlist_hide_comment_count',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Comment Count', 'koala'),
				'section' => 'postlist_section',
			)
		);
		...
		$wp_customize->add_section('pagination_section',
			array(
				'title' => esc_html('Pagination', 'koala'),
				'description' => esc_html('This section contains Pagination options.', 'koala'),
				'priority' => 28,
			)
		);
		...
		$wp_customize->add_control('pagination_hide_older_newer',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Older/Newer Buttons', 'koala'),
		...
		$wp_customize->add_control('pagination_hide_page_numbers',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Page Numbers', 'koala'),
				'section' => 'pagination_section',
			)
		);
		...
		$wp_customize->add_section('postpage_section',
			array(
				'title' => esc_html('Post Page', 'koala'),
				'description' => esc_html('This section contains Post Page options.', 'koala'),
				'priority' => 29,
			)
		);
		...
		$wp_customize->add_control('postpage_enable_cover_fade',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Enable Cover Fade', 'koala'),
		...
		$wp_customize->add_control('postpage_hide_social_share',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Social Share', 'koala'),
				'section' => 'postpage_section',
			)
		);
		...
		$wp_customize->add_control('postpage_hide_tags',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Tags', 'koala'),
				'section' => 'postpage_section',
			)
		);
		...
		$wp_customize->add_control('postpage_hide_related',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Related Posts', 'koala'),
				'section' => 'postpage_section',
			)
		);
		...
		$wp_customize->add_control('postpage_hide_author_profile',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Author Profile', 'koala'),
				'section' => 'postpage_section',
			)
		);
		...
		$wp_customize->add_control('postpage_hide_comments',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Comments', 'koala'),
				'section' => 'postpage_section',
			)
		);
		...
		$wp_customize->add_control('postpage_hide_next_prev_posts',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Next/Previous Posts', 'koala'),
				'section' => 'postpage_section',
			)
		);
		...
		$wp_customize->add_section('custompage_section',
			array(
				'title' => 'Custom Page',
				'description' => esc_html('This section contains Custom Page options.', 'koala'),
				'priority' => 30,
			)
		);
		...
		$wp_customize->add_control('custompage_show_author',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Show Author', 'koala'),
		...
		$wp_customize->add_control('custompage_show_date',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Show Date', 'koala'),
				'section' => 'custompage_section',
			)
		);
		...
		$wp_customize->add_control('custompage_show_comment_count',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Show Comment Count', 'koala'),
				'section' => 'custompage_section',
			)
		);
		...
		$wp_customize->add_control('custompage_show_social_share',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Show Social Share Options', 'koala'),
				'section' => 'custompage_section',
			)
		);
		...
		$wp_customize->add_control('custompage_hide_title',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Page Title', 'koala'),
				'section' => 'custompage_section',
			)
		);
		...
		$wp_customize->add_section('footer_section',
			array(
				'title' => esc_html('Footer', 'koala'),
				'description' => esc_html('This section contains Footer options.', 'koala'),
				'priority' => 31,
			)
		);
		...
		$wp_customize->add_control('footer_hide_footer',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Footer', 'koala'),
		...
		$wp_customize->add_control('footer_hide_widgets',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Widgets', 'koala'),
				'section' => 'footer_section',
			)
		);
		...
		$wp_customize->add_control('footer_hide_copyright',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Copyright', 'koala'),
				'section' => 'footer_section',
			)
		);
		...
		$wp_customize->add_control('footer_hide_social',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Hide Social', 'koala'),
				'section' => 'footer_section',
			)
		);
		...
		$wp_customize->add_section('adverts_section',
			array(
				'title' => esc_html('Adverts & AdSense', 'koala'),
				'description' => esc_html('This section contains Advert & AdSense options.', 'koala'),
				'priority' => 32,
			)
		);
		...
		$wp_customize->add_control('adverts_enable',
			array(
				'type' => 'checkbox',
				'label' => esc_html('Enable Advert/AdSense Support', 'koala'),
		...
		$wp_customize->add_control('adverts_occurance_rate',
			array(
				'type' => 'select',
				'label' => esc_html('Show Every (X) Posts', 'koala'),
				'section' => 'adverts_section',
				'choices' => array(
					2 => '2',
					3 => '3',
		...
		$wp_customize->add_control('adverts_ad_code',
			array(
				'type' => 'text',
				'label' => esc_html('Advert Emebed Code (728x90)', 'koala'),
				'section' => 'adverts_section',
			)
		);
