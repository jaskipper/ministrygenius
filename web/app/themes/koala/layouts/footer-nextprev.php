	...
	<section class="nextprev">
		<div class="wrapper-body">
			...
			<?php if(!empty($previous_post)){
				$thumb_url = wp_get_attachment_image_src(get_post_thumbnail_id($previous_post->ID), 'ecko_opengraph');
			?>
			...
			<?php if(!empty($next_post)){
					$thumb_url = wp_get_attachment_image_src(get_post_thumbnail_id($next_post->ID), 'ecko_opengraph');
			?>
