	...
	<section class="post-author-profile">
		<div class="inner">
			...
			<ul class="authorsocial">
				...
				<?php } ?>
				<?php if(get_the_author_meta('slideshare', $post->post_author) != ''){ ?>
					<li><a href="<?php echo esc_url(get_the_author_meta('slideshare', $post->post_author)); ?>" target="_blank" class="socialminimal slideshare" title="SlideShare"><i class="fa fa-slideshare"></i></a></li>
				<?php } ?>
			</ul>
		</div>
	</section>
