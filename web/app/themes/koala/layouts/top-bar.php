			...
			<div class="logo">
				<?php if($cover_logo != ""){ ?>
					<?php if(is_front_page()){ ?>
						<h1><a href="<?php echo esc_url(home_url()); ?>"><img src="<?php echo esc_url($cover_logo); ?>" class="retina" alt="<?php esc_attr(bloginfo('name')); ?>"></a><span class="logo-alt"><?php esc_html(bloginfo('name')); ?></span></h1>
					<?php }else{ ?>
						<a href="<?php echo esc_url(home_url()); ?>"><img src="<?php echo esc_url($cover_logo); ?>" class="retina" alt="<?php esc_attr(bloginfo('name')); ?>"></a>
					<?php } ?>
				<?php }else{ ?>
					<?php if(is_front_page()){ ?>
						<h1 itemprop="headline"><a href="<?php echo esc_url(home_url()); ?>"><?php esc_html(bloginfo('name')); ?></a></h1>
					<?php }else{ ?>
