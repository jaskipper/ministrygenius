<?php
	...
	define('ECKO_FRAMEWORK_VERSION', '1.9.1');
	...
	* @return string HEX color value for the category
	...
	function ecko_customize_register($wp_customize){
		...
		$wp_customize->add_setting('social_slideshare',
		array(
			'sanitize_callback' => 'ecko_sanitize_text'
		));
		$wp_customize->add_control('social_slideshare',
			array(
				'label' => esc_html('SlideShare Profile URL', 'ecko'),
				'section' => 'social_section',
				'type' => 'text',
			)
		);
